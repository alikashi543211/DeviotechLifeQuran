...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4 col-6">
            <div class="card">
                <a href="{{route('admin.student.inquiries')}}">
                    <div class="card-header d-flex align-items-start pb-0">
                        <div>
                            <h2 class="text-bold-700 mb-0 text-primary">{{$total_inquiries}}</h2>
        ...
        <div class="col-md-4 col-6">
            <div class="card">
                <a href="{{route('admin.student.inquiries')}}?inquiries=pending">
                    <div class="card-header d-flex align-items-start pb-0">
                        <div>
                            <h2 class="text-bold-700 mb-0 text-success">{{$pending_inquiries}}</h2>
                            <p class="text-success">Pending Inquiries</p>
                        </div>
        ...
        <div class="col-md-4 col-6">
            <div class="card">
                <a href="{{route('admin.student.inquiries')}}?inquiries=trial">
                    <div class="card-header d-flex align-items-start pb-0">
                        <div>
                            <h2 class="text-bold-700 mb-0 text-primary">{{$trial_inquiries}}</h2>
                            <p class="text-primary">On Trial</p>
                        </div>
                        <div class="avatar bg-rgba-primary p-50 m-0">
                            <div class="avatar-content">
                                <i class="feather icon-database text-primary font-medium-5"></i>
        ...
        <div class="col-md-4 col-6">
            <div class="card">
                <a href="{{route('admin.student.inquiries')}}?inquiries=continue">
                    <div class="card-header d-flex align-items-start pb-0">
                        <div>
                            <h2 class="text-bold-700 mb-0 text-info">{{$schedule_req_inquiries}}</h2>
