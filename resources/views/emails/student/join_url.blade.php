...
<head>
    ...
    <title>LiveQuran Email Notifications</title>
</head>
            ...
            <table border="0" cellpadding="0" cellspacing="0" align="center"
                ...
                <tr>
                    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;  padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
                        ...
                        Hello Student Join the Meeting
                    </td>
                </tr>
                <tr>
                    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
                ...
                <tr>
                    <td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
                        ...
                        Thank you for Joinging LifeQuran Platform. Your Tutor just Started the Class for you. Kindly join the Meeting via by clicking "Join the Meeting" Button.
                ...
                <tr>
                    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
                        ...
                        <a href="{{ $data['join_url'] }}" target="_blank" style="text-decoration: none;">
                ...
                <tr>
                    <td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
                        ...
                        If you’re having trouble clicking the button, copy and paste the URL below into your web browser: <a style="color: #3869d4;
                        font-size: 14px;" href="{{ $data['join_url'] }}">{{ $data['join_url'] }}</a>
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
