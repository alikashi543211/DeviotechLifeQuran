...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%;" class="background"><tr><td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; color:#000 !important; padding: 0;"
	...
	font-family: sans-serif; justify-content: center;" class="paragraph">
                        You have successfully Send your Message to Admin.
                        Your details:
	...
	font-family: sans-serif; justify-content: center;" class="paragraph">
                        ...
                        <div style="padding-bottom: 5px;">Full Name: <strong style="color: black;font-size: 18px;">{{$data['user']->name ?? ''}}</strong></div>
                        <div style="padding-bottom: 5px;">Email: <strong style="color: black;font-size: 18px;">{{$data['user']->email ?? ''}}</strong></div>
                        <div style="padding-bottom: 5px;">Category: <strong style="color: black;font-size: 18px;">{{$data['chat']->category ?? ''}}</strong></div>
                        <div style="padding-bottom: 5px;">Priorirty: <strong style="color: black;font-size: 18px;">{{$data['chat']->priorirty ?? ''}}</strong></div>
                        <div style="padding-bottom: 5px;">Message: <strong style="color: black;font-size: 18px;">{{$data['chat']->message ?? ''}}</strong></div>
                        <div style="padding-bottom: 5px;">Objectives: <strong style="color: black;font-size: 18px;">{{$data['chat']->object ?? ''}}</strong></div>
	...
	color: black;
	font-family: sans-serif; justify-content: center;" class="paragraph">
                        Click the Login button to complete your profile.
