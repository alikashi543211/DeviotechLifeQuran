...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%;" class="background"><tr><td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; color:#000 !important; padding: 0;"
	...
	font-family: sans-serif; justify-content: center;" class="paragraph">
                        You session for {{$data['inquiry']->study_type ?? ''}} has been schedule for trial class.
	...
	font-family: sans-serif; justify-content: center;" class="paragraph">
                        ...
                        <div style="padding-bottom: 5px;">Date: <strong style="color: black;font-size: 18px;">{{$data['schedule']->date ?? ''}}</strong></div>
                        @php
                            $exc_start=strtotime($data['schedule']->time)+($data['inquiry']->time_zone*60);
                            $strt_time=date("H:i",$exc_start);
                        @endphp
                        <div style="padding-bottom: 5px;">Time: <strong style="color: black;font-size: 18px;"> {{$strt_time}}  {{--{{$data['schedule']->time ?? ''}}--}}</strong></div>
                    </td>
                </tr>
